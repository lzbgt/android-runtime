    ...
    if (arg.IsEmpty()) {
        ...
        case CastType::None:
            ...
            if (success) {
                ...
                s << "Cannot marshall JavaScript argument " << (*jsObjStr ? *jsObjStr : "<failed-to-string>") << " at index " << index << " to Java type.";
            }
            break;
        ...
        s << "Cannot marshall JavaScript argument at index " << index << " to Java type.";
        success = false;
    }
